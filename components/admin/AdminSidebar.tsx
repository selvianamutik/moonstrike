...
export function AdminSidebar() {
  ...
  const filteredItems = navItems.filter((item) => {
    if (allowedPermissions === null) return false;
    if (item.href === "/admin/dashboard") return true;

    let key = "";
    if (item.href.startsWith("/admin/users")) key = "users";
    else if (item.href.startsWith("/admin/games")) key = "games";
    else if (item.href.startsWith("/admin/services")) key = "services";
    ...
    else if (item.href.startsWith("/admin/admins")) key = "admins";
